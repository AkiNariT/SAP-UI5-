...
You can now consume the predefined `SAP-icons` icon font in an environment where OpenUI5 isn't available. An example for integration is given [here](../08_More_About_Controls/icon-and-icon-pool-21ea0ea.md#loio21ea0ea94614480d9a910b2e93431291__section_whp_y2l_mmb).
