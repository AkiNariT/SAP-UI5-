...
-   The option to use the OpenUI5 OData V4 model with an OData V2 service is now deprecated. To use the OpenUI5 OData V4 model, migrate your service to OData V4. For more information, see [Consuming OData V2 Services with the OData V4 Model \(deprecated\)](../04_Essentials/consuming-odata-v2-services-with-the-odata-v4-model-deprecated-365bdbd.md).
