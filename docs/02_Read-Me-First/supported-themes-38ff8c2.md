...
## Supported Themes in OpenUI5 Versions

The following table shows the [Available Themes](../04_Essentials/available-themes-da0d2e7.md) for the supported OpenUI5 libraries and the versions in which they were introduced and ceased to be supported.
